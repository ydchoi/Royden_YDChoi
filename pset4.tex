...
\eQb
|s - \eta | < \dfrac{\epsilon}{4m(I)M}
 \text{ on } F \text{ and } m(I\setminus F) < \dfrac{\epsilon}{4m(I)M}.
\eQe
It follows that
\eQb
\int_{\mathbb{R}} | f- s| &=& \int_{\mathbb{R}} |f -\eta + \eta - s| \\
&\leq& \int_{\mathbb{R}} |f - \eta| + |\eta - s| \\
&=& \int_{\mathbb{R}} |f - \eta| + \int_{\mathbb{R}} |\eta - s| \\
&=& \int_{\mathbb{R}} |f - \eta| + \int_{I} |\eta - s| +
\int_{S\setminus I} |\eta - s| \\ 
&=& \int_{\mathbb{R}} |f - \eta| + \int_{I\setminus F} |\eta - s| +
\int_{F} |\eta -s| + \int_{S\setminus I} |\eta - s|. 
\eQe
As $s = 0$ outside of $I$, we have that
\eQb
\int_{\mathbb{R}} |f-s| &\leq& 
\int_{\mathbb{R}} |f - \eta| + \int_{I\setminus F} |\eta - s| +
...
of the inequality:
\eQb
\int_{\mathbb{R}} |f-s| &\leq& \dfrac{\epsilon}{4} \\
\int_{I\setminus F} |\eta - s| &\leq& 
M\dfrac{\epsilon}{4m(I)M} \leq \dfrac{\epsilon}{4} \\
\int_{F} |\eta - s| &\leq& \int_{I} |\eta -s| \leq 
\dfrac{\epsilon}{4m(I)M}m(I) \leq \dfrac{\epsilon}{4} \\ 
\int_{S \setminus I} |\eta| &\leq& \dfrac{\epsilon}{4M}M = 
\dfrac{\epsilon}{4}. \\
\eQe
Hence, it follows that 
\eQb
\int_{\mathbb{R}} |f-s| \leq \epsilon,
\eQe
as desired. $\qed$
