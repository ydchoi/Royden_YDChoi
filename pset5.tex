...
As $f$ and $g$ are both absolutely continuous, 
...
we have shown that $f+g$ is absolutely continuous.
...
As $f$ is absolutely continuous, there exists
...
Let $f$ be an absolutely continuous function on $[a,b]$.
We wish to show that $f^2$ is absolutely continuous. As $f$ is absolutely
