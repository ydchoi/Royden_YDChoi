...
and $g$ are continuous, and composition of continuous map is continuous,
we have $g \circ \phi$ is continuous on $X$. Therefore, by the given, 
$g \circ \phi(X)$ attains a minimum value. Since $\phi(X) = Y$, we have
$g \circ \phi(X) = g(Y)$. Hence, $g(Y)$ attains a minimum value. $g$
was considered to be an arbitrary, continuous function. Therefore,
